class TalkNetASD:
    ...
    def __predict__(
        ...
        :param save_path: the directory to save intermediate files.
        ...
        if return_visualization:
            out, video_path = main(self.s, self.DET, video, start_seconds=start_time, end_seconds=end_time, return_visualization=return_visualization, face_boxes=face_boxes, in_memory_threshold=in_memory_threshold, save_path=save_path)
            return video_path
        else:
            out = main(self.s, self.DET, video, start_seconds=start_time, end_seconds=end_time, return_visualization=return_visualization, face_boxes=face_boxes, in_memory_threshold=in_memory_threshold, save_path=save_path)
